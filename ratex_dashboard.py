...
if "Employee" in mode or "Combined" in mode:
    if emp_raw is not None:
        ...
        with c2:
            ...
            st.plotly_chart(sf(fig, key="chart_2"), use_container_width=True)
        ...
        with c1:
            if "Department" in emp.columns:
                ...
                st.plotly_chart(sf(fig, key="chart_3"), use_container_width=True)
        ...
        with c1:
            ...
            fig.update_traces(marker_line_color="#0a0e1a", marker_line_width=0.5, opacity=0.85)
            st.plotly_chart(sf(fig, key="chart_15"), use_container_width=True)
    ...
    if empr_raw is not None:
        ...
        with c2:
            ...
            if industry_col:
                ...
                fig.update_traces(texttemplate='%{text:.3f}', textposition='outside', marker_line_width=0)
                fig.update_coloraxes(showscale=False)
                st.plotly_chart(sf(fig, key="chart_19"), use_container_width=True)
        ...
        if dim_cols:
            ...
            fig.update_traces(texttemplate='%{text:.3f}', textposition='outside', marker_line_width=0)
            fig.update_coloraxes(showscale=False)
            st.plotly_chart(sf(fig, key="chart_20"), use_container_width=True)
        ...
        with c2:
            ...
            if size_col:
                ...
                fig.update_traces(texttemplate='%{text:.3f}', textposition='outside', marker_line_width=0)
                fig.update_coloraxes(showscale=False)
                st.plotly_chart(sf(fig, key="chart_22"), use_container_width=True)
        ...
        fig.update_traces(marker_line_color="#0a0e1a", marker_line_width=0.5, opacity=0.85)
        st.plotly_chart(sf(fig, key="chart_23"), use_container_width=True)
